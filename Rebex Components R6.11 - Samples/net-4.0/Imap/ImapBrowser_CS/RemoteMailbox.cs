...
namespace Rebex.Samples
{
    ...
    {
        public static readonly string ConfigFilePath = Path.Combine(Environment.GetFolderPath(System.Environment.SpecialFolder.LocalApplicationData), string.Format("Rebex{0}Secure Mail{0}ImapBrowser.xml",Path.DirectorySeparatorChar));
        ...
        // Disables automatic perform of the action.
        private bool _startSubsequentAction = true;
        ...
        private Rebex.Samples.ImapFolderSelector folderSelector;
        ...
        public RemoteMailbox()
        {
            ...
            folderSelector.SelectedFolderChanged += new EventHandler(folderSelector_SelectedFolderChanged);
            ...
            _listViewItemSorter.Sorting = System.Windows.Forms.SortOrder.Descending;
        ...
        public void AddMessage(ImapMessageInfo message, bool error)
        {
            if (message.HeadersParsingError == null)
            {
        ...
        public void RemoveMessage(string uniqueId)
        {
            try
            {
                ...
                {
                    ImapMessageInfo m = (ImapMessageInfo)item.Tag;
        ...
        private void StartCheckForUpdates()
        {
            if (!_worker.IsRunning)
            {
                ...
                _worker.StartCheckForUpdates(new Worker.FinishedDelegate(OnFinished));
            }
        }
        ...
        private void OnFinished(Exception error)
        {
            if (error == null)
            {
                ...
                if (!folderSelector.IsInitialized)
                {
                    folderSelector.SetClient(_worker.Client);
                }
                else
                {
                    if (_startSubsequentAction)
                    {
                        switch(_currentAction)
                        {
                            ...
                            case Actions.RetrievingMessages: 
                                if(!_worker.RetrieveMessageListFinished)
                                    RefreshFolder(false);
                                else if(cbCheckForUpdates.Checked)
        ...
        private void ReportError(Exception error)
        {
            ...
            ImapException imapError = error as ImapException;
            if (imapError != null)
            {
                if (imapError.Status == ImapExceptionStatus.ProtocolError)
        ...
        private void InitializeComponent()
        {
            ...
            this.folderSelector = new Rebex.Samples.ImapFolderSelector();
            ...
            this.panel4.Controls.Add(this.cbCheckForUpdates);
            ...
            // cbCheckForUpdates
            // 
            this.cbCheckForUpdates.Location = new System.Drawing.Point(8, 80);
            this.cbCheckForUpdates.Name = "cbCheckForUpdates";
            this.cbCheckForUpdates.Size = new System.Drawing.Size(130, 20);
            this.cbCheckForUpdates.Text = "Check for new mails";
            this.cbCheckForUpdates.Checked = true;
            this.cbCheckForUpdates.Enabled = true;
            this.cbCheckForUpdates.CheckedChanged += new EventHandler(cbCheckForUpdates_CheckedChanged);
            //
            // cbSingleSignOn
            //
            this.cbSingleSignOn.Location = new System.Drawing.Point(138, 80);
            ...
            this.listView.Location = new System.Drawing.Point(240, 135);
            ...
            // folderSelector
            // 
            this.folderSelector.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                | System.Windows.Forms.AnchorStyles.Left)));
            this.folderSelector.Location = new System.Drawing.Point(0, 135);
            this.folderSelector.Name = "folderSelector";
            this.folderSelector.Size = new System.Drawing.Size(241, 260);
            this.folderSelector.TabIndex = 7;
            // 
            // columnHeaderFrom
            // 
            ...
            this.btnSettings.Location = new System.Drawing.Point(192, 79);
            ...
            this.cbSecurity.Size = new System.Drawing.Size(116, 21);
            ...
            this.Text = "IMAP Mailbox Browser";
        ...
        private void menuView_Click(object sender, System.EventArgs e)
        {
            ...
            _worker.Abort(new EventHandler(menuView_Click_Inner));
        }

        // View message.
        private void menuView_Click_Inner(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ImapMessageInfo m = (ImapMessageInfo)selCol[0].Tag;
        ...
        {
            _startSubsequentAction = false;
            _worker.Abort(new EventHandler(menuDelete_Click_Inner));
        }

        // Delete message.
        private void menuDelete_Click_Inner(object sender, System.EventArgs e)
        {
            _startSubsequentAction = true;
            try
            {
                ...
                if ((selCol != null) && (selCol.Count > 0))
                {
                    ...
                    {
                        ImapMessageInfo m = (ImapMessageInfo)selCol[i].Tag;
        ...
        {
            _startSubsequentAction = false;
            _worker.Abort(new EventHandler(menuItemSave_Click_Inner));
        }

        // Save the message.
        private void menuItemSave_Click_Inner(object sender, System.EventArgs e)
        {
            _startSubsequentAction = true;
            try
            {
        ...
        private void RefreshFolder(bool clearChache)
        {
            string selectedFolder = folderSelector.SelectedFolder;

            if(_selectedFolder != selectedFolder)
            {
                listView.Items.Clear();
            ...
            if (selectedFolder != null)
            {
                ...
                _worker.SetFolder(selectedFolder);
        ...
        private void btnOpen_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                if (_worker.IsRunning)
                {
                    if(_currentAction == Actions.RetrievingMessages)
                        _currentAction = Actions.CheckingForUpdates;
                    else
                ...
                else
                {
                    PrepareForWorker();
                    if (!folderSelector.IsInitialized)
                        _worker.StartConnecting(new Worker.FinishedDelegate(OnFinished));
                    else
                        RefreshFolder(true);
                }				
            }
        ...
        private void folderSelector_SelectedFolderChanged(object sender, EventArgs e)
        {
            _startSubsequentAction = false;
            _worker.Abort(new EventHandler(btnOpen_Click));
        }
        ...
        private void listView_ColumnClick(object sender, ColumnClickEventArgs e)
        {
            ...
            if (_listViewItemSorter.Sorting == System.Windows.Forms.SortOrder.Descending)
                _listViewItemSorter.Sorting = System.Windows.Forms.SortOrder.Ascending;
            else
                _listViewItemSorter.Sorting = System.Windows.Forms.SortOrder.Descending;
