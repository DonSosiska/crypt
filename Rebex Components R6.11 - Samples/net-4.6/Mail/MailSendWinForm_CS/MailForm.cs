...
namespace Rebex.Samples
{
    ...
    {			
        ...
        private void btnSend_Click(object sender, System.EventArgs e)
        {
            ...
            else if (radioSendAsyncAwait.Checked)
            {
                SendMessageUsingAwait(message);
            }
        }

        private async void SendMessageUsingAwait(MailMessage message)
        {
            try
            {
        ...
        public async Task ConnectAndLoginAsync()
        {
            ...
            if (cbSingleSignOn.Checked)
                await _smtp.LoginAsync(SmtpAuthentication.Auto); //single sign-on authentication
