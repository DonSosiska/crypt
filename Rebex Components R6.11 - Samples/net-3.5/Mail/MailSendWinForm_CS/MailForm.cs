    ...
    {			
        ...
        private void SendMessageAsync(MailMessage message)
        {
            try
            {
                ...
                (
                    message,
                    new AsyncCallback(AsyncSendCompletedProxy),
                    null
                );
            }
            catch (Exception x)
        ...
        /// </summary>
        private void AsyncSendCompletedProxy(IAsyncResult asyncResult)
        {
            // pass the arguments to a method that runs in the thread that owns this control
            Invoke(new FinishedDelegate(AsyncSendCompleted), new object[] {asyncResult});
        }
        ...
        private void AsyncSendCompleted(IAsyncResult asyncResult)
        {
            try
            {
